...
const MENU_ITEMS_BASE = [
    ...
    { id: 'hakem-karnesi',icon: 'assessment',            label: 'Hakem Karnesi',  desc: 'Trimmed-mean, sayılmayan notlar, il dağılımı', color: '#9333EA', subpath: '/hakem-karnesi',   permKey: 'audit',           disciplines: null },
